...
import com.example.mymoney_final.Fragment.ViCuaToi.EditWallet;
...
public class Chi extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        Cursor data = createDatabase.GetData("SELECT * FROM GiaoDich where MaND = " + MaND + " and Loai = 1 ORDER BY Ngay DESC");
    ...
    public void ChiTietGD_Dialog (int gravity) {
        ...
        Toast.makeText(getActivity(), String.valueOf(MaGD), Toast.LENGTH_SHORT).show();
